...
define( function( require ) {
  ...
  return inherit( PhetioObject, ObservableArray, {
    ...
    _fireItemAdded: function( item ) {
      this.tandem.isSuppliedAndEnabled() && this.phetioStartEvent( 'model', 'itemAdded', this.phetioType.elementType.toStateObject && this.phetioType.elementType.toStateObject( item ) );
    ...
    _fireItemRemoved: function( item ) {
      this.tandem.isSuppliedAndEnabled() && this.phetioStartEvent( 'model', 'itemRemoved', this.phetioType.elementType.toStateObject && this.phetioType.elementType.toStateObject( item ) );
